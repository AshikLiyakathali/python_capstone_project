...
migrate_btn = tk.Button(root, textvariable = migrate_text, font = 'raleway', 
                        height = 2, width = 15, bg = 'green', command = move_to_cloud)
...
read_btn = tk.Button(root, textvariable = read_text, font = "raleway", bg = "green", 
                    height = 2, width = 15, command = read_from_cloud)
